...
/**
 * Protocolo de comunicação entre cliente Android e servidor desktop
 * Baseado no protocolo do servidor desktop
 */
public class Protocol {
    ...
    // Comandos de Movimentação (Lançamentos)
    ...
    /**
     * Parseia comando recebido do servidor
     */
    ...
    /**
     * Monta comando para envio ao servidor
     */
