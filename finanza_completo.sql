-- ================================================
-- FINANZA DATABASE SETUP SCRIPT
-- Sistema de Gestão Financeira Pessoal
-- SQLite Database - Versão de Produção
-- ================================================
...
- Servidor roda na porta 8080 (compatível com Android)
- CORS configurado para aceitar conexões da rede local
- Android conecta via IP da rede (ex: 192.168.1.100:8080)
- Desktop conecta via localhost:8080
...
- Estrutura compatível com Android (Room/SQLite)
*/